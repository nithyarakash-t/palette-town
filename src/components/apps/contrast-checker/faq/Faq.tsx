...
const faq = [
    ...
    },
    {
        ...
        answer: "Proper color contrast makes your designs more inclusive by improving readability for users with visual impairments. With Figmas Color Contrast Checker, you can adjust and experiment with colors to meet accessibility standards."
    },
    {
    ...
    {
        question: "What are the passing criterions for normal text",
    ...
    {
        question: "What are the passing criterions for link texts with only color as differentator",
        answer: "Note that crieteria from normal text apply here too. For usability and accessibility, links should be underlined by default. Otherwise, link text must have at least 3:1 contrast with surrounding body text, and must present a non-color indicator (typically underline) on mouse hover and keyboard focus. In addition, both links and body text must have at least 4.5:1 contrast with the background (3:1 for large text) to meet WCAG 2 Level AA."
    },
    {
        question: "What are the passing criterions for UI elements",
