...
export function Main() {
    ...
    return (
        <section className='cg-main__wrap'>
            ...
            <div className={`cg-main__venn ${'-' + difficulty}`}>
                <div className={`cg-main__vennitem -selected ${'-' + difficulty}`} style={{backgroundColor: inputColor}}></div>
                {
                    (difficulty === 'assisted' || difficulty === 'easy') &&
                    <div className={`cg-main__vennitem -question ${'-' + difficulty}`} style={{backgroundColor: targetColor.hex}}>
                        <div>
            ...
            {(difficulty === 'assisted' || difficulty === 'easy') && <div className={`cg-main__yinyang ${'-' + difficulty}`}
