...
function CopyToClipboard({textToCopy}:{readonly textToCopy: string}) {
    const handleCopy = () => {
        navigator.clipboard.writeText(textToCopy);
    }
    return <button type='button' className='cc-colorinfo__copy' aria-label='copy to clipboard' onClick={handleCopy}></button>
}